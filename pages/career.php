...
<form id="hiddenformbackward" method="post" action="career-yesterday.php">
    <input type="hidden" name="zodiacsign" value="<?= $zodiacsign ?>">
</form>
<form id="hiddenformforward" method="post" action="career-tomorrow.php">
    <input type="hidden" name="zodiacsign" value="<?= $zodiacsign ?>">
</form>
        ...
        <div class="row">
            ...
            <div class="col-md-8 col-lg-8 col-sm-8 col-8 d-flex align-items-stretch" data-aos="zoom-in"
                ...
                <div class="icon-box">
                    ...
                    <p class="description"><?= $horoscope["career-today"] ?></p>
                    <br><br><br>
