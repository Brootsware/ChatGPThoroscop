...
function generateHoroscope($sign)
{
  ...
  $text = "Write 2 paragraphe daily horoscope for $sign ";
  $parameters = [
    'prompt' => $text,
    'temperature' => 0.7,
    'max_tokens' => 400,
...
<form id="hiddenformbackward" method="post" action="general-yesterday.php">
    <input type="hidden" name="zodiacsign" value="<?= $zodiacsign ?>">
</form>
<form id="hiddenformforward" method="post" action="general-tomorrow.php">
    <input type="hidden" name="zodiacsign" value="<?= $zodiacsign ?>">
</form>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-2 col-lg-2 col-sm-2 col-2 d-flex align-items-stretch" data-aos="zoom-in"
                data-aos-delay="100">
                <a href="general-yesterday.php"
                    class="right-left-arrow d-flex align-items-center justify-content-center"
