...
function generateHoroscope($sign)
{
    ...
    $text = "Write 2 paragraphe daily horoscope for $sign related to money.";
    $parameters = [
        'prompt' => $text,
        'temperature' => 0.7,
        'max_tokens' => 400,
    ...
    try {
        ...
        $data['money-date'] = $last_updated;


        $data['money-yesterday'] = $data['money-today'];
        $data['money-today'] = $data['money-tomorrow'];
        $data['money-tomorrow'] = $string;
...
$lastupdated = $horoscope["money-date"];
...
<form id="hiddenformforward" method="post" action="money.php">
...
<section id="services" class="services section-bg">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-2 col-lg-2 col-sm-2 col-2 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            ...
            <div class="col-md-8 col-lg-8 col-sm-8 col-8 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="200">
                <div class="icon-box">
                    <!-- <div class="icon"><i class="bx bx-file"></i></div> -->
                    <h4 class="title">Yesterday's Horoscope</h4>
                    <p class="description"><?= $horoscope["money-yesterday"] ?></p>
                    <br><br><br>
                    <a class="button-custom" style="margin-left: 0px;" href="../index.html">Check out more</a>
                </div>
            </div>

            <div class="col-md-2 col-lg-2 col-sm-2 col-2 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="300">
                <a href="#" class="right-left-arrow d-flex align-items-center justify-content-center" style="margin-inline: auto;" onclick="document.getElementById('hiddenformforward').submit(); return false;"><i class="bi bi-arrow-right-short"></i></a>
            </div>
