...
function generateHoroscope($sign)
{
  ...
  $text = "Write 2 paragraphe daily horoscope for $sign related to love and relationship";
  $parameters = [
    'prompt' => $text,
    'temperature' => 0.7,
    'max_tokens' => 400,
  ...
  try {
    ...
    $data['love-date'] = $last_updated;


    $data['love-yesterday'] = $data['love-today'];
    $data['love-today'] = $data['love-tomorrow'];
    $data['love-tomorrow'] = $string;
...
$lastupdated = $horoscope["love-date"];
...
<form id="hiddenformbackward" method="post" action="love-yesterday.php">
    <input type="hidden" name="zodiacsign" value="<?= $zodiacsign ?>">
</form>
<form id="hiddenformforward" method="post" action="love-tomorrow.php">
    <input type="hidden" name="zodiacsign" value="<?= $zodiacsign ?>">
</form>
        ...
        <div class="row">
            ...
            <div class="col-md-8 col-lg-8 col-sm-8 col-8 d-flex align-items-stretch" data-aos="zoom-in"
                ...
                <div class="icon-box">
                    ...
                    <p class="description"><?= $horoscope["love-today"] ?></p>
                    <br><br><br>
