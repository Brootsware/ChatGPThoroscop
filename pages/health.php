...
function generateHoroscope($sign)
{
  ...
  $text = "Write 2 paragraphe daily horoscope for $sign related to health.";
  $parameters = [
    'prompt' => $text,
    'temperature' => 0.7,
    'max_tokens' => 400,
  ...
  try {
    ...
    $data['health-date'] = $last_updated;


    $data['health-yesterday'] = $data['health-today'];
    $data['health-today'] = $data['health-tomorrow'];
    $data['health-tomorrow'] = $string;
...
$lastupdated = $horoscope["health-date"];
...
<form id="hiddenformbackward" method="post" action="health-yesterday.php">
    <input type="hidden" name="zodiacsign" value="<?= $zodiacsign ?>">
</form>
<form id="hiddenformforward" method="post" action="health-tomorrow.php">
    <input type="hidden" name="zodiacsign" value="<?= $zodiacsign ?>">
</form>
        ...
        <div class="row">
            <div class="col-md-2 col-lg-2 col-sm-2 col-2 d-flex align-items-stretch" data-aos="zoom-in"
                ...
                <a href="#" class="right-left-arrow d-flex align-items-center justify-content-center"
                    ...
                    onclick="document.getElementById('hiddenformbackward').submit(); return false;"><i
            ...
            <div class="col-md-8 col-lg-8 col-sm-8 col-8 d-flex align-items-stretch" data-aos="zoom-in"
                ...
                <div class="icon-box">
                    ...
                    <h4 class="title">Today's Horoscope</h4>
                    <p class="description"><?= $horoscope["health-today"] ?></p>
                    <br><br><br>
